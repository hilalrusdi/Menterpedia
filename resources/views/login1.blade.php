        ...
        <div class="body d-md-flex">
            ...
            <div class=" box-2 d-flex flex-column h-100">
                <div class="m-5 text-center text-color-prymary">
                    ...
                    <div class="d-flex flex-column ">
                        ...
                        <form action="/login" method="POST">
                          @csrf
                            <div class="mb-3">
                              <input type="email" name="email" class="form-control @error("email")is-invalid @enderror " id="email" aria-describedby="emailHelp" placeholder="Email" required value="{{ old('email') }}">
                              @error('email')
                            ...
                            <div class="mb-3">
                                <input type="password" name="password" class="form-control" id="password" aria-describedby="emailHelp" placeholder="Password" required>
                            </div>
                ...
                <div class="mt-auto text-color-link">
                    <p class="footer mb-0 mt-md-0 mt-4 text-center">Belum Memiliki Akun? <a href="/register-customer">Daftar</a> </p>
                </div>
